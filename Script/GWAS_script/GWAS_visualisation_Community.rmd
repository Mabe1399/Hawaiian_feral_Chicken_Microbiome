...
GWAS_output_Chao1 <- read.delim("")

GWAS_output_InvSimpson <- read.delim("/Users/matiasbeckerburgos/Desktop/Master_in_Bioinformatics/Master_Thesis/Hawaiian_feral_Chicken_Microbiome/Analysis/GWAS/InvSimpson/cc5k.autosomes.selectFERAL.renamesamples.minimize.vcftoplink.geno_microbiome_extra_2-job9611984.3_CLR_GWAS-job9614558.assoc.txt")

# Import the one Without outliers

GWAS_output_Simpson_wo_out <- read.delim("/Users/matiasbeckerburgos/Desktop/Master_in_Bioinformatics/Master_Thesis/Hawaiian_feral_Chicken_Microbiome/Analysis/GWAS/Simpson/without_outliers/cc5k.autosomes.selectFERAL.renamesamples.minimize.vcftoplink.geno_microbiome_extra_2-job9611984.4_CLR_GWAS-job9614627.assoc.txt")

GWAS_output_Shannon_wo_out <- read.delim("/Users/matiasbeckerburgos/Desktop/Master_in_Bioinformatics/Master_Thesis/Hawaiian_feral_Chicken_Microbiome/Analysis/GWAS/Shannon/without_outliers/cc5k.autosomes.selectFERAL.renamesamples.minimize.vcftoplink.geno_microbiome_extra_2-job9611984.5_CLR_GWAS-job9614665.assoc.txt")

GWAS_output_Pielou_wo_out <- read.delim("/Users/matiasbeckerburgos/Desktop/Master_in_Bioinformatics/Master_Thesis/Hawaiian_feral_Chicken_Microbiome/Analysis/GWAS/Pielou/")
```
