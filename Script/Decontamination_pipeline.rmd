...
metadata <- metadata[!(row.names(metadata) %in% c("039", "040", "041")), ]
...
rm(list = ls()[!(ls() %in% c("seqtab.nochim", "taxa", "save", "ps", "ps_rare_filt", "ps_Norm", "rare", "ps_filt", "ps_Norm_filt", "metadata"))])
