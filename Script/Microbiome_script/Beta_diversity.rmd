...
PCA_aitch <- plot_ordination(ps_Norm, ord_ps, justDF = T)
head(PCA_aitch)

# extract % variation
sum1 <- sum(ord_clr$CA$eig)
tempx <- as.character(round(((ord_clr$CA$eig[1] / sum1) * 100), 2))
tempy <- as.character(round(((ord_clr$CA$eig[2] / sum1) * 100), 2))
set.seed(386)
